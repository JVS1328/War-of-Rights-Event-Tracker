...
const SeasonTracker = () => {
  ...
  const simulateSeason = () => {
    ...
    const simulatedWeeks = bestSchedule.weeks.map((weekData, i) => {
      ...
      // Use the balanced teams generated by tryGenerateSchedule
      // Schedule-only mode still gets full balanced teams, just without simulated results
      const teamA = weekData.teamA;
      const teamB = weekData.teamB;
